...
describe("기수별 참가자 명단", () => {
  it("DB ID가 기수와 달라도 활성 2기를 먼저 보여주고 1기 전원을 보존한다", () => {
    ...
    const groups = groupParticipants([
      ...
      { id: 1, name: "2기", is_active: true, start_date: "2026-09-01", end_date: "2026-12-31" },
    ], participants, "2026-09-15");
    ...
    expect(groups[1].members[0]).toEqual({ id: "11", name: "김하나", affiliation: "교육지원과", selectable: true });
  });
