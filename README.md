...
- 이름 선택 후 참가자 홈 최상단에 크루 전체 현황 표시: 기간 경과, 확정 기준 제출률, 오늘 완료·대기·마감 후 미제출 인원, 일별 활동 격자·주별 공유·누적 그래프
- 홈과 성장 상세는 동일한 챌린지 전체 기간·제외 기준으로 집계하며, 개인 월별 기록은 전체 현황 아래에 별도 표시
- 날짜 칸 선택으로 크루 전체 공유 수와 공유한 참가자 수 확인, 알림 설정은 홈 맨 아래에 고정 배치
- 홈 활동 그래프와 크루 공유 합계는 마감 후·주말·공휴일·운영 제외일의 링크를 제외
